...
if [ ! -f "$SETUP_FLAG" ]; then
    ...
    apt-get install aptitude exiv2 webp libcurl4-openssl-dev libomp-dev clang cmake ninja-build nano nvtop htop ncurses-term lshw screen aria2 unzip libstdc++-12-dev caddy -y
    apt-get install google-perftools git python3.10 python3.10-distutils python3.10-venv ffmpeg -y
